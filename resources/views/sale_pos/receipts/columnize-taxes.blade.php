...
<table style="width:100%;">
	...
	<tbody>
		<tr>
			<td class="text-center" style="line-height: 15px !important; padding-bottom: 10px !important; margin-top:5px !important">
...
<div class="row color-555">
	<div class="col-xs-12">
		...
		<table class="table table-bordered table-no-top-cell-border table-slim">
			<thead>
				<tr style="background-color: #357ca5 !important; color: black !important; font-size: 15px !important font-weight: bold;" class="table-no-side-cell-border table-no-top-cell-border text-center">
					<td style="background-color: #357ca5 !important; color: black !important;">#</td>
					
					<td style="background-color: #357ca5 !important; color: Black !important;" class="text-left" width="30%">
						{!! $receipt_details->table_product_label !!}
					</td>

					@if($receipt_details->show_cat_code == 1)
						<td style="background-color: #357ca5 !important; color: black !important;" class="text-right">{!! $receipt_details->cat_code_label !!}</td>
					@endif
					
					<td style="background-color: #357ca5 !important; color: black !important;" class="text-right">
					...
					<td style="background-color: #357ca5 !important; color: black !important;">
						{!! $receipt_details->item_discount_label !!}
					</td>
					@endif
					<td style="background-color: #357ca5 !important; color: black !important;" class="text-right">
						Taxable Value <span class="small color-black"> ({{$receipt_details->currency['symbol']}})</span>
					</td>

					@if(!empty($receipt_details->table_tax_headings))
					
						@foreach($receipt_details->table_tax_headings as $tax_heading)
							<td style="background-color: #357ca5 !important; color: black !important;" class="word-wrap text-right">
								{{$tax_heading}} <span class="small color-black"> ({{$receipt_details->currency['symbol']}})</span>
							</td>

							@php
								$totals[$tax_heading] = 0.000;
							@endphp
						@endforeach
						...
						@foreach($receipt_details->table_tax_headings as $tax_heading)
							<td class="text-right word-wrap">
								...
								@else
									...
									<span class="display_currency" data-currency_symbol="false">
									{{$line['tax_formatted'] * $line['quantity_uf']}}
									</span>
									<br/>
									<span class="small">
										{{$line['tax_percent']}}%
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #357ca5 !important; color: black !important" class="font-23 padding-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-23 padding-10" style="background-color: #357ca5 !important; color: black !important">
